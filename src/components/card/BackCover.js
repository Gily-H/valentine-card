...
const BackCover = () => {
  ...
  const openBack = () => {
    setIsBackOpen((prevIsBackOpen) => true);
  };

  const closeBack = () => {
    setIsBackOpen((prevIsBackOpen) => false);
  };

  return (
    <div className="back-page">
      {isBackOpen ? (
        <div className={`card back-page-front ${isBackOpen && "card-open"}`} onClick={closeBack}>
          ...
          <p className="message-content">
            ...
            netus et malesuada. Nulla facilisi morbi tempus iaculis. Ullamcorper eget nulla facilisi etiam dignissim.
            Urna et pharetra pharetra massa massa ultricies. Leo a diam sollicitudin tempor id eu nisl nunc mi.
            Habitasse platea dictumst quisque sagittis purus sit amet volutpat. Porttitor massa id neque aliquam
            vestibulum. Vitae aliquet nec ullamcorper sit. Dignissim convallis aenean et tortor at risus viverra.
          </p>
          <h2 className="message-signature">From Honey</h2>
        </div>
      ) : (
        <div className="card back-page-back" onClick={openBack}>
